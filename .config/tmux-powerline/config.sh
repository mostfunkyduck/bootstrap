...
# General {
	...
	# The theme to use.
	export TMUX_POWERLINE_THEME="jack"
...
# ifstat-jack.sh {
  export TMUX_SEGMENT_IFSTAT_JACK_INTERFACE="Total"
# }

# my tmux cpu load shit {
  export TMUX_SEGMENT_TMCL_JACK_ARGS="-g 0 -q"
# }
# battery.sh {
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/home/jack/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/home/jack/.mailcheckrc"
# }
...
# pwd.sh {
	...
	export TMUX_POWERLINE_SEG_PWD_MAX_LEN=""
# }
